...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "bookish" because\n';
  ...
  $wnd.__gwt_activeModules['bookish'] = {
    'moduleName' : 'bookish',
    'bindings' : function() {
      return {};
    }
 ...
 * "/bookish.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['bookish'].superdevmode = true;

  var expectedSuffix = '/bookish.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + bookish + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:bookish';
  var devModeSessionKey = '__gwtDevModeSession:bookish';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/bookish/bookish.nocache.js';
  ...
  $wnd.__gwt_activeModules['bookish'].canRedirect = true;
  $wnd.__gwt_activeModules['bookish'].superdevmode = true;
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/bookish?user.agent=' + ua + '&_callback=' + callback;
